...
#PROMPTS
code_header = f"""You are an AI assistant with up-to-date knowledge for Omuliant, a medication developed by Eli Lilly. You assist the Medical Affairs Europe 
                department employees of Eli Lilly. Omuliant is a medication featuring the active ingredient baricitinib, primarily used to treat for diseases 
                like Rheumatoid arthritis, Juvenile idiopathic arthritis and other diseases. Generate your answer ONLY with the facts based solely on the provided embeddings in elaborated way. Your responses are rooted in 
...
- If a query does not pertain to legitimate Omuliant related inquiry, respond with: "I'm sorry, I can only assist with Olumiant related queries."
...
def preprocess_user_input(user_input, message_history, temp=0.3, max_tok=300):
    ...
    system_message = """Enhance the user's query based on the conversation history. The conversation history consists of a user asking questions related to Omuliant, a drug containing Baricitinib as its active ingredient.
