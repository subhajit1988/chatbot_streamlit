...
#PROMPTS
code_header = f"""You are an expert medical AI assistant with up-to-date knowledge for VERZENIOS, a medication developed by Eli Lilly. 
                OLUMIANT is a medication featuring the active ingredient ABEMACICLIB, primarily used to treat breast cancer. 
...
- If a query does not pertain to legitimate VERZENIOS related inquiry, respond with: "I'm sorry, I can only assist with VERZENIOS related queries."
...
def preprocess_user_input(user_input, message_history, temp=0.3, max_tok=300):
    ...
    system_message = """Enhance the user's query based on the conversation history. The conversation history consists of a user asking questions related to VERZENIOS, a drug containing ABEMACICLIB as its active ingredient.
